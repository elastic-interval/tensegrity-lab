...
use crate::build::scanner::Token::{Atom, Float, Ident, Integer, Paren, Percent, EOF};
use crate::build::scanner::{ScannedToken, Token};
use crate::build::expression::ErrorKind::{ConsumeFailed, MatchExhausted};
