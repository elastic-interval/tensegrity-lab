(library
  ...
  (brick ; single-right
    (proto
      ...
      (pulls 2.0
        (pull :alpha_x :omega_z 1)
        (pull :alpha_y :omega_x 1)
        (pull :alpha_z :omega_y 1) )
      (faces
    ...
    (baked
      ...
      (joint 0.6229 0.6229 0.6229)
      (interval 4 3 0.1171 1)
      (interval 4 5 -0.0531 0)
      (interval 0 1 -0.0531 0)
      (interval 2 1 0.1171 1)
      (interval 2 3 -0.0531 0)
      (interval 0 5 0.1171 1)
  ...
  (brick ; single-left
    (proto
      ...
      (pushes Z 3.204 (push :alpha_z :omega_z))
      (pulls 2.0
        (pull :alpha_x :omega_y 1)
        (pull :alpha_y :omega_z 1)
        (pull :alpha_z :omega_x 1))
      (faces
    ...
    (baked
      ...
      (joint -0.6229 -0.6229 -0.6229)
      (joint 0.6229 0.6229 0.6229)
      (interval 0 3 0.1171 1)
      (interval 2 3 -0.0531 0)
      (interval 0 1 -0.0531 0)
      (interval 4 5 -0.0531 0)
      (interval 2 5 0.1171 1)
      (interval 4 1 0.1171 1)
  ...
  (brick
    ...
    (baked
      ...
      (joint -0.7758 0.7758 -0.7758)
      (joint -0.7758 -0.7758 -0.7758)
      (interval 10 11 -0.0473 0)
      (interval 6 7 -0.0473 0)
      (interval 4 5 -0.0473 0)
      (interval 8 9 -0.0473 0)
      (interval 0 1 -0.0473 0)
      (interval 2 3 -0.0473 0)
  ...
  (brick
    (proto (alias Torque)
      ...
      (pulls 2.5
        (pull :middle_front :front_left_bottom 1)
        (pull :middle_front :front_left_top 1)
        (pull :middle_front :front_right_bottom 1)
        (pull :middle_front :front_right_top 1)
        (pull :middle_back :back_left_bottom 1)
        (pull :middle_back :back_left_top 1)
        (pull :middle_back :back_right_bottom 1)
        (pull :middle_back :back_right_top 1))
      (faces
    ...
    (baked
      (alias Torque)
      (joint -1.6518 0.0000 -2.6932)
      (joint 1.6518 -0.0000 -2.6932)
      (joint -1.6916 -0.0000 -0.0000)
      (joint 1.6916 0.0000 -0.0000)
      (joint -1.6518 -0.0000 2.6932)
      (joint 1.6518 0.0000 2.6932)
      (joint -1.0937 -1.6601 -2.0302)
      (joint -1.0937 1.6601 -2.0302)
      (joint -1.0937 -1.6601 2.0302)
      (joint -1.0937 1.6601 2.0302)
      (joint 1.0937 -1.6601 -2.0302)
      (joint 1.0937 1.6601 -2.0302)
      (joint 1.0937 -1.6601 2.0302)
      (joint 1.0937 1.6602 2.0302)
      (joint -0.0000 0.8055 -3.3251)
      (joint 0.0000 0.8055 3.3251)
      (joint -0.0000 -0.8055 -3.3251)
      (joint 0.0000 -0.8055 3.3251)
      ...
      (joint -0.9063 0.8099 2.6963)
      (joint 0.9063 0.8099 2.6963)
      (interval 3 12 0.0772 1)
      (interval 8 9 -0.0408 0)
      (interval 0 1 -0.0456 0)
      (interval 12 13 -0.0408 0)
      (interval 6 7 -0.0408 0)
      (interval 3 10 0.0772 1)
      (interval 10 11 -0.0408 0)
      (interval 2 6 0.0772 1)
      (interval 2 3 -0.0229 0)
      (interval 2 7 0.0772 1)
      (interval 3 13 0.0772 1)
      (interval 2 9 0.0772 1)
      (interval 4 5 -0.0456 0)
      (interval 3 11 0.0772 1)
      (interval 2 8 0.0772 1)
      (interval 14 15 -0.0393 0)
      (interval 16 17 -0.0393 0)
