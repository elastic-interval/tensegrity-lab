...
class IMPORT_OT_quick_usd_reload(bpy.types.Operator):
    ...
    def execute(self, context):
        # New file without save prompt
        bpy.ops.wm.read_homefile(app_template="")
        
        # Set world background to black
        bpy.context.scene.world.node_tree.nodes["Background"].inputs[0].default_value = (0, 0, 0, 1)
        
        # Import your USD file - change this path to your file
        bpy.ops.wm.usd_import(filepath="~/RustRoverProjects/tensegrity_lab/animation.usda")
        
        # Optional: set the imported camera as active
