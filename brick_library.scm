  ...
  (brick ; single-left
    ...
    (brick
      ...
      (baked
        ...
        (left 17 5 12 (alias :left FarBrother TorqueLeft) (alias :right FarOtherB TorqueLeft) (alias :base :seed RightBackBottom TorqueLeft))
    ...
    (brick
      (proto (alias TorqueRight)
        ...
        (face-aliases (with :right)
          ...
          (alias Brother) (alias OtherB) (alias FarOtherB) (alias FarBase))
        (face-aliases (with :left)
          (alias :base) (alias OtherA) (alias FarBase) (alias FarOtherB)
          (alias OtherB) (alias Brother) (alias FarBrother) (alias FarOtherA))
        (face-aliases (with :seed)
          (alias LeftFrontBottom :base) (alias LeftBackBottom :base) (alias RightBackBottom :base) (alias RightFrontBottom :base)
          (alias LeftBackTop) (alias LeftFrontTop) (alias RightFrontTop) (alias RightBackTop)))
      (baked
        ...
        (interval 12 13 -0.0504 :push)
        (left 17 5 12 (alias :right FarOtherA TorqueRight) (alias :left FarBase TorqueRight) (alias :base :seed RightBackBottom TorqueRight))
        (right 17 4 8 (alias :right FarBrother TorqueRight) (alias :left FarOtherB TorqueRight) (alias :base :seed RightFrontBottom TorqueRight))
        (left 15 4 9 (alias :right FarOtherB TorqueRight) (alias :left FarBrother TorqueRight) (alias :seed RightFrontTop TorqueRight))
        (right 16 3 10 (alias :base :right TorqueRight) (alias :left OtherA TorqueRight) (alias :base :seed LeftBackBottom TorqueRight))
        (right 15 5 13 (alias :right FarBase TorqueRight) (alias :left FarOtherA TorqueRight) (alias :seed RightBackTop TorqueRight))
