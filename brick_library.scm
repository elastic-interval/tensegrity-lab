(brick-library
  ...
  (brick ; single-left
    ...
    (brick
      ...
      (baked
        (joint -0.7039 1.4632 0.0000)
        (joint 0.7039 1.4632 -0.0000)
        (joint -1.3573 2.2825 -1.9516)
        (joint 1.3573 0.6440 -1.9516)
        (joint -1.3573 0.6440 1.9516)
        (joint 1.3573 2.2825 1.9516)
        (joint -1.9315 0.4217 -1.4279)
        (joint 0.3778 2.9264 -1.1956)
        (joint 0.3778 0.0000 1.1956)
        (joint -1.9315 2.5047 1.4279)
        (joint -0.3778 0.0000 -1.1956)
        (joint 1.9315 2.5047 -1.4279)
        (joint 1.9315 0.4217 1.4279)
        (joint -0.3778 2.9264 1.1956)
        (joint 0.5942 2.1285 -2.6228)
        (joint -0.5942 2.1285 2.6228)
        (joint -0.5942 0.7980 -2.6228)
        (joint 0.5942 0.7980 2.6228)
        (joint -1.3451 1.1862 -1.9556)
        (joint 0.2329 0.5077 -1.9486)
        (joint 1.3451 1.1862 1.9556)
        (joint -0.2329 0.5077 1.9486)
        (joint 1.3451 1.7402 -1.9556)
        (joint -0.2329 2.4188 -1.9486)
        (joint -1.3451 1.7402 1.9556)
        (joint 0.2329 2.4188 1.9486)
        ...
        (right 15 5 13 (alias :left Far:Base TorqueLeft) (alias :right Base:Side TorqueLeft) (alias :seed Rogjt:Back:Top TorqueLeft))
    ...
    (brick
      ...
      (baked
        ...
        (right 15 5 13 (alias :left Far:Base TorqueRight) (alias :right Base:Side TorqueRight) (alias :seed Rogjt:Back:Top TorqueRight))
