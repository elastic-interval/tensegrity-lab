    ...
    (brick
      (proto (alias TorqueLeft)
        ...
        (faces
          ...
          (right :top_right :right_back :back_right_top))
        (face-aliases (with :left)
          (alias :base) (alias OtherA) (alias FarOtherB) (alias FarOtherA)
          (alias OtherB) (alias Brother) (alias FarBase) (alias FarOtherB))
        (face-aliases (with :right)
          (alias OtherA) (alias :base) (alias FarOtherB) (alias FarBase)
          (alias Brother) (alias OtherB) (alias FarOtherA) (alias FarBrother))
        (face-aliases (with :seed)
          (alias LeftFrontBottom :base) (alias LeftBackBottom :base) (alias RightBackBottom :base) (alias RightFrontBottom :base)
          (alias LeftBackTop) (alias LeftFrontTop) (alias RightFrontTop) (alias RightBackTop)))
      (baked
        ...
        (joint 0.5942 1.7979 2.6228)
        (joint -1.3451 2.1862 -1.9556)
        (joint 0.2329 1.5077 -1.9486)
        (joint 1.3451 2.1862 1.9556)
        (joint -0.2329 1.5077 1.9486)
        (joint 1.3451 2.7402 -1.9556)
        (joint -0.2329 3.4187 -1.9486)
        (joint -1.3451 2.7402 1.9556)
        (joint 0.2329 3.4187 1.9486)
        ...
        (right 14 2 7 (alias :left Brother TorqueLeft) (alias :right OtherB TorqueLeft) (alias :seed LeftFrontTop TorqueLeft))
        (left 17 5 12 (alias :left FarOtherB TorqueLeft) (alias :right FarOtherB TorqueLeft) (alias :base :seed RightBackBottom TorqueLeft))
        (left 15 4 9 (alias :left FarBase TorqueLeft) (alias :right FarOtherA TorqueLeft) (alias :seed RightFrontTop TorqueLeft))
        (left 14 3 11 (alias :left OtherB TorqueLeft) (alias :right Brother TorqueLeft) (alias :seed LeftBackTop TorqueLeft))
        (right 15 5 13 (alias :left FarOtherB TorqueLeft) (alias :right FarBrother TorqueLeft) (alias :seed RightBackTop TorqueLeft))
        (left 16 2 6 (alias :base :left TorqueLeft) (alias :right OtherA TorqueLeft) (alias :base :seed LeftFrontBottom TorqueLeft))
        (right 16 3 10 (alias :left OtherA TorqueLeft) (alias :base :right TorqueLeft) (alias :base :seed LeftBackBottom TorqueLeft))
        (right 17 4 8 (alias :left FarOtherA TorqueLeft) (alias :right FarBase TorqueLeft) (alias :base :seed RightFrontBottom TorqueLeft)))
      )
    (brick
      (proto (alias TorqueRight)
        ...
        (faces
          ...
          (right :top_right :right_back :back_right_top))
        (face-aliases (with :right)
          (alias OtherA) (alias :base) (alias FarOtherA) (alias OtherBrother)
          (alias Brother) (alias OtherB) (alias FarOtherB) (alias OtherBase))
        (face-aliases (with :left)
          (alias :base) (alias OtherA) (alias OtherBase) (alias FarOtherB)
          (alias OtherB) (alias Brother) (alias OtherBrother) (alias FarOtherA))
        (face-aliases (with :seed)
          (alias LeftFrontBottom :base) (alias LeftBackBottom :base) (alias RightBackBottom :base) (alias RightFrontBottom :base)
          (alias LeftBackTop) (alias LeftFrontTop) (alias RightFrontTop) (alias RightBackTop)))
      (baked
        ...
        (right 14 2 7 (alias :right OtherB TorqueRight) (alias :left Brother TorqueRight) (alias :seed LeftFrontTop TorqueRight))
        (left 15 4 9 (alias :right FarOtherB TorqueRight) (alias :left OtherBrother TorqueRight) (alias :seed RightFrontTop TorqueRight))
        (right 17 4 8 (alias :right OtherBrother TorqueRight) (alias :left FarOtherB TorqueRight) (alias :base :seed RightFrontBottom TorqueRight))
        (right 15 5 13 (alias :right OtherBase TorqueRight) (alias :left FarOtherA TorqueRight) (alias :seed RightBackTop TorqueRight))
        (right 16 3 10 (alias :base :right TorqueRight) (alias :left OtherA TorqueRight) (alias :base :seed LeftBackBottom TorqueRight))
        (left 16 2 6 (alias :right OtherA TorqueRight) (alias :base :left TorqueRight) (alias :base :seed LeftFrontBottom TorqueRight))
        (left 17 5 12 (alias :right FarOtherA TorqueRight) (alias :left OtherBase TorqueRight) (alias :base :seed RightBackBottom TorqueRight))
        (left 14 3 11 (alias :right Brother TorqueRight) (alias :left OtherB TorqueRight) (alias :seed LeftBackTop TorqueRight)))
      )
    )