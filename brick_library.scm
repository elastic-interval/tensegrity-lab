  ...
  (brick ; single-left
    ...
    (brick
      ...
      (baked
        ...
        (right 15 5 13 (alias :right FarOtherB TorqueLeft) (alias :left FarBrother TorqueLeft) (alias :seed RightBackTop TorqueLeft))
        (left 14 3 11 (alias :right OtherB TorqueLeft) (alias :left Brother TorqueLeft) (alias :seed LeftBackTop TorqueLeft))
        (left 15 4 9 (alias :right FarBase TorqueLeft) (alias :left FarOtherA TorqueLeft) (alias :seed RightFrontTop TorqueLeft))
        (left 17 5 12 (alias :right FarOtherB TorqueLeft) (alias :left FarOtherB TorqueLeft) (alias :base :seed RightBackBottom TorqueLeft))
        (left 16 2 6 (alias :base :right TorqueLeft) (alias :left OtherA TorqueLeft) (alias :base :seed LeftFrontBottom TorqueLeft))
        (right 16 3 10 (alias :right OtherA TorqueLeft) (alias :base :left TorqueLeft) (alias :base :seed LeftBackBottom TorqueLeft))
        (right 14 2 7 (alias :right Brother TorqueLeft) (alias :left OtherB TorqueLeft) (alias :seed LeftFrontTop TorqueLeft))
        (right 17 4 8 (alias :right FarOtherA TorqueLeft) (alias :left FarBase TorqueLeft) (alias :base :seed RightFrontBottom TorqueLeft)))
      )
    (brick
      ...
      (baked
        ...
        (interval 4 5 -0.0519 :push)
        (interval 6 7 -0.0504 :push)
        (left 17 5 12 (alias :left FarOtherA TorqueRight) (alias :right OtherBase TorqueRight) (alias :base :seed RightBackBottom TorqueRight))
        (left 14 3 11 (alias :left Brother TorqueRight) (alias :right OtherB TorqueRight) (alias :seed LeftBackTop TorqueRight))
        (left 15 4 9 (alias :left FarOtherB TorqueRight) (alias :right OtherBrother TorqueRight) (alias :seed RightFrontTop TorqueRight))
        (right 15 5 13 (alias :left OtherBase TorqueRight) (alias :right FarOtherA TorqueRight) (alias :seed RightBackTop TorqueRight))
        (right 16 3 10 (alias :base :left TorqueRight) (alias :right OtherA TorqueRight) (alias :base :seed LeftBackBottom TorqueRight))
        (right 17 4 8 (alias :left OtherBrother TorqueRight) (alias :right FarOtherB TorqueRight) (alias :base :seed RightFrontBottom TorqueRight))
        (left 16 2 6 (alias :left OtherA TorqueRight) (alias :base :right TorqueRight) (alias :base :seed LeftFrontBottom TorqueRight))
